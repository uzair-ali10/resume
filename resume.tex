...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks and Technologies}{: Django, Gin, ExpressJS, NodeJS, REST APIs, GraphQL} \\
     \textbf{Databases}{: PostgreSQL, MongoDB, Redis} \\
     \textbf{Developer Tools}{: Postman, Git, Heroku, Azure, GitHub Actions, Docker, AWS (S3, EC2)} \\
