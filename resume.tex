...
country of Jamaica}
        ...
        \resumeItem{\textbf{Improved} the Existing \textbf{Mutation and Query} which reduced response time by 5\%}
        \resumeItem{\textbf{Reviewed Pull-Request} of new contributors}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
           ...
           \resumeItem{Engineered \textbf{REST APIs} following a \textbf{microservice} architecture}
           \resumeItem{Implemented \textbf{CI/CD} Pipeline using \textbf{GitHub Actions}}
           \resumeItem{Tested API endpoints using \textbf{pytest} with 84\% coverage}
           \resumeItem{increased productivity of technical bloggers by 20\%}
           \resumeItem{Serving over 100 active users per day}
